...
String getHTML(){
  ...
  ptr += "\n";
  ptr += "        .day #nightbg {\n";
  ptr += "        transform: scale(100vw, 100vh);\n";
  ptr += "        }\n";
  ptr += "\n";
  ptr += "        .day .star {\n";
  ptr += "        width: 50px;\n";
  ...
  ptr += "\n";
  ptr += "                    var timerTimes = splitted[ 2 ].split( ' ' );\n";
  ptr += "                    var timerStates = splitted[ 3 ].split( ' ' );\n";
  ptr += "\n";
  ...
  ptr += "\n";
  ptr += "                                //convert minutes back to string to fill up the values to get 00:00 and not 0:0\n";
  ...
  ptr += "                                    Timer set for ${time} to ${action}\n";
  ...
  ptr += "                            }\n";
  ptr += "\n";
  ptr += "                            displayTimer(hours + ':' + minutes, action, i);\n";
  ptr += "                        }\n";
  ptr += "                    }\n";
  ptr += "                })\n";
  ptr += "        }\n";
